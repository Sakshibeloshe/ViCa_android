...
// ViCa Android — Phases 1, 2, 3 dependencies
// ============================================================================
plugins {
    id("com.android.application")
    id("org.jetbrains.kotlin.android")
    id("com.google.devtools.ksp")          // KSP for Room annotation processing
    id("com.google.dagger.hilt.android")   // Hilt DI (optional, for ProximityManager injection)
...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26          // API 26 = Android 8.0 — required for BLE LE Audio APIs
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // -----------------------------------------------------------------------
    // Phase 2 & 3: Proximity Engine
    // No extra dependencies needed:
    //   - NFC HCE: android.nfc.cardemulation.HostApduService (framework)
    //   - BLE:     android.bluetooth.le (framework)
    //   - Sensors: android.hardware.SensorManager (framework)
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // Hilt DI (optional — remove if not using DI)
    // -----------------------------------------------------------------------
